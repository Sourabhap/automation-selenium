...
public class PositiveTests {
	...
	public void registrationTest()
	{
		...
		driver.findElement(By.name("name")).sendKeys("sourabh");
		sleep(1500);
		driver.findElement(By.name("email")).sendKeys("patilsourabha98@gmail.com");
		sleep(1500);
		driver.findElement(By.name("password")).sendKeys("souarabh*24");
		sleep(1500);
		driver.findElement(By.name("phone")).sendKeys("8552959860");
		sleep(1500);
